...
namespace BuildMvcViews
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class BuildMvcViewsCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("a28449b2-9413-439e-8d8b-4a2c55d9695c");
        ...
        /// </summary>
        public static BuildMvcViewsCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            // Verify the current thread is the UI thread - the call to AddCommand in BuildMvcViewsCommand's constructor requires
            // the UI thread.
        ...
        {
            ThreadHelper.ThrowIfNotOnUIThread();
            package.BuildCurrentProjectWithBuildMvcViews();
        }
    }
}
